...
class DeltaNet(nn.Module):
    r"""
    The layer implementaion for the corresponding method.  # noqa:
    DeltaNet was originally proposed in the corresponding method. # noqa
    ...
    Args:
        ...
        allow_neg_eigval (bool, Optional):
            ...
            See reference: the corresponding method
